                    ...
                    <table class="table table-striped">
                      ...
                      <tbody pull-{right}>
                        ...
                        <tr>
                          ...
                          <td>{{  $daftarsubjek->subject->day }}</td>
                          <td>{{  $daftarsubjek->subject->starttime }}</td>
                          <td>{{  $daftarsubjek->subject->endtime }}</td>
                          <td>
                          @if( $daftarsubjek->user_id == Auth::user()->id)
                              <a href="{{ action('DaftarsubjeksController@destroy', $daftarsubjek->id) }}" class="btn btn-danger btn-sm" id="confirm-modal">Delete</a>
                          @endif
                        </td>
                          </tr>
